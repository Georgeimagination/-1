...
MI355X 的 TBP（总板级功耗）为 1400W，产品页列 Passive & Active 冷却，白皮书 Table 2 列 Passive/Liquid，并重点介绍直接液冷的高密度系统。DLC（Direct Liquid Cooling，直接液冷）是该产品的重要部署方案，但这些资料并未将每个 MI355X OAM 限定为唯一一种冷却实现；所查来源未给出冷板、入口温度、流量与压降。[1, Requirements / Board Specifications] [2, p.1] [3, p.3; Table 2, p.19] 产品简报将较高功率预算与减少长时间高负载下的 throttling（降频）联系起来；这是官方设计目标，原文未给保证持续频率。[2, p.1 Designed for High-Density Computing]
