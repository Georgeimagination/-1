...
MI350X 的 maximum TBP（总板级功耗）为 1000W，采用 54V UBB 供电和被动散热 OAM。白皮书将其放在风冷系统与既有 UBB 2.0 平台兼容的路线中；兼容平台并不保证无需调整服务器的供电、散热或固件。典型功耗、环境温度和可长期维持峰值的条件没有公开。[1, Requirements / Board Specifications] [2, p.1] [3, p.3, Table 2]
