...
if(fs.existsSync(comparisonFile)){
 ...
 comparisonHtml=`<article id="comparison" class="comparison" data-title="${esc(comparisonTitle)}" hidden><div class="eyebrow">两层比较 · 36 个产品 · 12 个产品组</div>${html}</article>`;
 nav=`<h3>横向比较</h3><a href="#comparison" data-search="比较 报告 训练 推理 comparison">两层比较 · ${comparisonFigureCount} 张图</a>`+nav;
...
if(fs.existsSync(scopeFile)){
 ...
 scopeEntry='<a class="report-entry" href="#comparison-scope"><strong>现有资料能支持多深入的比较？</strong><span>共同维度、数据覆盖与执行条件 · 家族内机制比较的适用范围</span></a>';
