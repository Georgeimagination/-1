...
| `FACT-M2W2-AWS-INF2-HBM-CAPACITY` | `CMP-M2W2-AWS-INF2-HBM / FIELD-MEM-CAPACITY` | `COND-M2W2-AWS-INF2-DEVICE-BW` | SRC-M2-GA-A04: 32 GiB<br>SRC-M2-GA-A05: 32 GiB | 34359738368 byte | SRC-M2-GA-A04: A04 v2.29.1 snapshot lines 1890-1894, Device Memory row<br>SRC-M2-GA-A05: A05 v2.29.1 snapshot lines 1928-1933, device overview | “32GiB of high-bandwidth device memory”<br>“total device memory capacity of 32GiB” |
...
| `FACT-M2W2-AWS-INF2-DMA-COUNT` | `CMP-M2W2-AWS-INF2-DMA / FIELD-COMP-UNIT-COUNT` | `COND-NONE` | SRC-M2-GA-A05: 32 DMA engines per device | 32 count | SRC-M2-GA-A05: A05 v2.29.1 snapshot lines 1931-1934, device overview | “32 DMA engines” |
| `FACT-M2W2-AWS-INF2-CC-COUNT` | `OBJ-AWS-INFERENTIA2-CHIP / FIELD-COMP-UNIT-COUNT` | `COND-NONE` | SRC-M2-GA-A05: 6 CC-Cores per device | 6 count | SRC-M2-GA-A05: A05 v2.29.1 snapshot lines 1933-1935, device overview | “6 CC-Cores for collective communication” |
| `FACT-M2W2-AWS-INF2-NEURONLINK-COUNT` | `LINK-M2W2-AWS-INF2-NEURONLINKV2 / FIELD-INT-PHYSICAL-LINK-COUNT` | `COND-NONE` | SRC-M2-GA-A05: 2 NeuronLink-v2 interfaces per Inferentia2 device | 2 count | SRC-M2-GA-A05: A05 v2.29.1 snapshot lines 1933-1935, device overview | “2 (Inferentia2) NeuronLink-v2” |
...
|---|---|
| `SRC-M2-GA-A04` | 在本卡直接支持 7 条事实：`FACT-M2W2-AWS-INF2-NCV2-COUNT`、`FACT-M2W2-AWS-INF2-CHIP-INT8-PEAK`、`FACT-M2W2-AWS-INF2-CHIP-MIXED-PEAK`、`FACT-M2W2-AWS-INF2-CHIP-FP32-PEAK`、`FACT-M2W2-AWS-INF2-HBM-CAPACITY`、`FACT-M2W2-AWS-INF2-HBM-BW-GIB`、`FACT-M2W2-AWS-INF2-DMA-BW`。这些事实的完整反向移除理由见 structured/selection-members.csv。 |
| `SRC-M2-GA-A05` | 在本卡直接支持 6 条事实：`FACT-M2W2-AWS-INF2-NCV2-COUNT`、`FACT-M2W2-AWS-INF2-HBM-CAPACITY`、`FACT-M2W2-AWS-INF2-HBM-BW-GB`、`FACT-M2W2-AWS-INF2-DMA-COUNT`、`FACT-M2W2-AWS-INF2-CC-COUNT`、`FACT-M2W2-AWS-INF2-NEURONLINK-COUNT`。这些事实的完整反向移除理由见 structured/selection-members.csv。 |
