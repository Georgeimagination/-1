...
$ExpectedCandidateAggregate='0d94c60e136fab58941ad8d1f6b5b55a4d2013a370c9a1dc938bd8005fa57bca'
...
$preflight=Join-Path $WorkRoot 'scripts\Test-MI455XFormalTransactionPreflight.ps1'
...
try{
    ...
    Write-Output "PASS: MI455X candidate oracle; $ExpectedValidatorChecks checks; aggregate $aggregate; target unchanged."
}
finally{
    if(Test-Path -LiteralPath $oracleFull){Remove-Item -LiteralPath $oracleFull -Recurse -Force}
}
