...
$expectedHashes = [ordered]@{
    '清单\论文PDF清单.csv' = '28d534ccd294b1d79043a20898f0dce3de3b2184c5e2c40ea9e68e6d0e981758'
    ...
    '清单\汇总统计.json' = 'ad56a6ca08a0d9cabd1b1a9916576674a00ce9d005026518c9fae9d28999a75e'
}
...
Add-EqualityCheck -Name 'PDF manifest row count' -Expected 107 -Actual $pdfRows.Count
...
Add-EqualityCheck -Name 'PDF files on disk' -Expected 107 -Actual $diskPdfFiles.Count
...
Add-EqualityCheck -Name 'PDF total bytes' -Expected ([long]297182050) -Actual $diskTotalBytes
...
if ($null -eq $pdfInfoExe) {
    Add-Check -Name 'PDF page count verification' -Status 'WARN' -Expected 2120 -Actual 'NOT_VERIFIED' -Critical $false -Details ('No explicit pdfinfo.exe was found. ' + $pdfInfoDiscoveryDetail).Trim()
}
else {
    ...
    Add-EqualityCheck -Name 'PDF total pages' -Expected 2120 -Actual $pageTotal
...
Add-EqualityCheck -Name 'Summary unique_pdfs' -Expected 107 -Actual ([int]$summary.unique_pdfs)
